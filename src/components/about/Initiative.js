  ...
  return (
      <Container>
        ...
        <Col></Col>
          ...
          <Col xxl={4} lg={5} md={6} style={{marginTop:"30px"}}>
            <p className="about-second-heading">
              An Initiative by the <br /> Govt. of Chhattisgarh
            </p>
            <hr className="about-who-first-hr" />
            <p>
              A Govt of Chhattisgarh and Tribal Co-operative Venture, dedicated
              to Tribal Development And Forest Resource Conservation through
              Sustainable Harvesting of Minor Forest Produce. With 74% Forest
              Cover of the country, CGMFP Federation accounts for 72% of the
              Minor Forest Produce procured across India.{" "}
            </p>
          </Col>
          <Col></Col>
        </Row>
