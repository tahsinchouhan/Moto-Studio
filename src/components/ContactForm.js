...
function ContactForm() {
  ...
  const {first_name_grievance, last_name_grievance, email_grievance, grievance_grievance, message_grievance} = inputTextGrievance
  ...
  const submitEventGrievance = async (e) => {
    e.preventDefault()
    try {
      if (first_name_grievance && last_name_grievance && email_grievance && grievance_grievance && message_grievance) {
        const response = await fetch(apipath + '/api/v1/grievance_category/user/create', {
          method: "post",
          headers: {
            'Content-Type': "application/json",
          },
              ...
              <Form className="Contact-Us-form pt-5" ref={GrievanceTab} >
                ...
                <Row>
                  ...
                  <FormControl className="category-minwidth col-12">
                    ...
                    >
                    {
                      grievCat.length && grievCat.map((cat,index)=>{
                        return(
                ...
                <div className="contac-sent-message text-center mt-3" onClick={submitEventGrievance}>
                  <ButtonLight onClick={submitEventGrievance} text="SEND GRIEVANCE"/>
                </div>
              </Form>
