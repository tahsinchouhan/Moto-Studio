  ...
  return (
    <>
      ...
      <div className="container py-5">
        ...
        <section>        
          <h5> Web Beacons and Tracking Links</h5>
        ...
        <section>        
          <h5> Cookies</h5>
           Browser Cookies are bits of text that are placed on your computer’s hard drive when you visit our website. Flash Cookies are similar to Browser Cookies except that they can store data more complex than simple text and are stored in your browser rather than on your hard drive. You can have your browser and/or plugs to your browser, such as flash, notify you of, or automatically reject, Cookies. If you reject our Cookies or opt-out of the use of cookies, you may still use this website, but you may be limited in the use of some of its features.
        </section>

        <section>        
          <h5> Information We Share and Who We Share With</h5>
            We will not provide your personally identifiable information to third parties for their use in marketing their products or services to you without your consent, except as provided in the “Business Transfers” Section below. In addition, we do not sell or otherwise disclose personally identifiable information about our website visitors except as described here.
        </section>
        ...
        <section>        
          <h5> Business Transfers</h5>
            As we continue to develop our business, we might sell certain of our assets. In such transactions, user information, including personal information, generally is one of the transferred business assets, and by submitting your personally identifiable information on the website you agree that your data may be transferred to such parties in these circumstances.
        </section>
          
        <section>        
          <h5> Compliance With Law</h5>
           We may disclose information that is necessary to comply with any applicable law, regulation, legal process or governmental request. In addition, we may disclose any information when it is necessary to prevent physical harm or financial loss or in connection with suspected or actual illegal activity.
        </section>

        <section>        
          <h5> Transfer of Data to Other Countries</h5>
           CG Herbals, our Affiliates and third parties who may receive your personal information in accordance with this Privacy Policy and the databases in which your personal information is stored shall be located in India and are required to honour the privacy representations made in this Privacy Policy under applicable laws of this country. In case of transfer of data to any other country, legal protections applicable to personal information in the concerned country will apply.
        </section>
        ...
        <section>        
          <h5> Updates to Our Privacy Policy</h5>
