    ...
    <div className="container-fluid partnership-opp">
      <div className="container-fluid partnership-opp-wrapper">
        ...
        <div className="d-flex justify-content-center mt-5 service-card-display-configuration">
          <Card
            className="border-0 service-card-marginright"
            style={{ width: "238px", marginRight: "60px" }}
          >
            <Image
              className="service-card-image-width"
              src={etendering}
              height={233}
            ></Image>
            <Card.Body>
              ...
              <Card.Text className="service-card-text">
                CGMFP Federation floats tenders at regular intervals for sale of
                raw and processed Minor Forest Produce. The tendering process is
                completely transparent and very convenient.
              </Card.Text>
          ...
          >
            ...
            <Card.Body>
              <Card.Title className="service-card-title">
                WHOLESALE FIXED PRICES
              </Card.Title>
              <Card.Text className="service-card-text">
                Organically certified Raw and Processed Minor Forest Produce are
                also available for sale at the fixed prices. Any firm/ agency,
                without participating in bidding process can purchase
                Raw/Processed Minor Forest Produce.
              </Card.Text>
              <Button className="service-cart-button-div">
          ...
          >
            ...
            <Card.Body>
              <Card.Title className="service-card-title">
                EMPANELMENT OF BULK BUYERS
              </Card.Title>
              <Card.Text className="service-card-text">
                Manufactures/ Exporters and traders etc. who wish to ensure a
                regular supply of minor forest produce based finished goods can
                do so by getting empanelled with the CGMFP. The empanelled
                buyers are given preference to ensure unhindered availability.
              </Card.Text>
          ...
          <Card className="border-0" style={{ width: "238px" }}>
            ...
            <Card.Body>
              <Card.Title className="service-card-title">
                EXPORT CHANNEL PARTNER
              </Card.Title>
              <Card.Text className="service-card-text">
                For export of MFP based Herbal Ayurvedic, Food and Personal Care
                products under ‘Chhattisgarh Herbals Brand’ across different
