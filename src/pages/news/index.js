          ...
          <div>
            <Row>
              <Col md={3} lg={3}>
                <div>
                  <div>
                    <h6 className="browse-news-articles">
                  ...
                  <div>
                    {dateList.length > 0 &&
                      [...new Set(dateList.map((item) => item.year))].map(
                        (year) => {
                          return (
                            <div className="blog-calender-2022" key={year}>
